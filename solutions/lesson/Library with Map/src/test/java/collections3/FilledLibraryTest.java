...
public class FilledLibraryTest {
    ...
    public void searchForIsbnReturnsCorrectBook() {
        assertSame("Library.searchForIsbn(…) should return the correct Book!", book1,
                library.searchForIsbn("123-1-11"));
        assertSame("Library.searchForIsbn(…) should return the correct Book!", book2,
                library.searchForIsbn("123-1-12"));
        assertSame("Library.searchForIsbn(…) should return the correct Book!", book3,
                library.searchForIsbn("123-1-13"));
        assertSame("Library.searchForIsbn(…) should return the correct Book!", book4,
                library.searchForIsbn("123-1-14"));
        assertSame("Library.searchForIsbn(…) should return the correct Book!", book5,
                library.searchForIsbn("123-1-15"));
    }

    @Test
    public void searchForIsbnReturnsNullIfNotFound() {
        assertNull(
                "Library.searchForIsbn(…) should return null if there is no Book with the specified ISBN!",
    ...
    public void searchForAuthorReturnsMatchingBook() {
        ...
        assertEquals(
                "Library.searchForAuthor(…) should only return the books of the given author!", 1,
                searchResult.size());
    }
    ...
    public void listStockByAuthorReturnsAllBooksOfEachAuthor() {
        ...
        assertEquals("Library.listStockByAuthor() should return all authors with all their books!",
                expected, actual);
    }
}
